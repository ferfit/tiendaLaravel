<div>
    ...
    <x-jet-dropdown width="96">
        ...
        <x-slot name="content">
                        ...
                        <article class="flex-1">
                            ...
                            <div class="flex">
                                ...
                                @isset($item->options['color'])
                                    <p class="mx-3">Color:{{__($item->options['color'])}}</p>
                                @endisset
                ...
                @empty
                    <li class="py-6 px-4">
                        <p class="text-center text-gray-700">
                            No tiene agregado items al carrito.
                        </p>
                    </li>   
                @endforelse
            </ul>
            @if (Cart::count())
                <div class="py-2 px-3">
                    <p class="text-lg text-gray-700 "><span class="font-bold">Total:</span> ${{Cart::subtotal()}}</p>
                    <x-button-enlace color="orange" class="w-full mt-2">
                        Ir al carrito
                    </x-button-enlace>
                </div>
